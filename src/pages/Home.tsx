...
import { Server, Video, Router, Network, Activity, ShieldCheck, Box, ExternalLink } from 'lucide-react';
...
const Home = () => {
    ...
    const modules = [
        ...
        },
        {
            ...
            description: "Visualização dinâmica da conexão entre switches e dispositivos.",
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex flex-col">
                ...
                <div className="px-6 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100">
                            ...
                            <span className="text-[10px] font-bold text-emerald-700 uppercase">Sistemas Online</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 max-w-6xl mx-auto w-full p-8 md:p-12 lg:p-16">
                <div className="mb-12">
                    <h2 className="text-3xl font-bold text-zinc-900 tracking-tight mb-2">Bem-vindo ao Dashboard de TI</h2>
                    <p className="text-zinc-500 font-medium">Selecione o módulo de infraestrutura que deseja gerenciar hoje.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {modules.map((module, i) => (
                        ...
                        >
                            <div className={`shrink-0 w-14 h-14 rounded-xl ${module.bg} ${module.color} flex items-center justify-center transition-transform duration-300 group-hover:scale-110`}>
                                {module.icon}
                            </div>

                            <div className="flex-1">
                                <div className="flex items-center justify-between mb-2">
                                    <h3 className="text-xl font-bold text-zinc-900">{module.title}</h3>
