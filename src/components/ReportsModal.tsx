      ...
      <DialogContent className="max-w-4xl h-[85vh] !flex flex-col p-0 overflow-hidden">
        ...
        >
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={async () => {
                    if (
                      confirm(
                        "Tem certeza que deseja apagar todo o histórico de relatórios?",
                      )
                    ) {
          ...
          <div className="flex-1 min-h-0">
            ...
            <TabsContent
              value="analytics"
              className="h-full m-0 outline-none data-[state=active]:flex flex-col"
            >
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between px-1">
                          ...
                          <Badge
                            variant="outline"
                            className="text-[10px] uppercase px-2 h-6"
                          >
                            Total: {analyticsIds.cameras.failures.length}
                          </Badge>
                        </div>
                            ...
                            <div className="min-w-[700px] h-[220px]">
                              {analyticsIds.cameras.failures.length > 0 ? (
                                <ResponsiveContainer width="100%" height="100%">
                                  <BarChart
                                    data={analyticsIds.cameras.failures}
                                    margin={{
                                      top: 10,
                                      right: 30,
                                      left: -25,
                      ...
                      <div className="space-y-4 pt-6">
                        <div className="flex items-center justify-between px-1">
                          ...
                          <Badge
                            ...
                            className="text-[10px] uppercase px-2 h-6"
                          >
                            Total: {analyticsIds.aps.failures.length}
                          </Badge>
                        </div>
                          ...
                          <div className="overflow-x-auto custom-scrollbar">
                            <div className="min-w-[700px] h-[220px]">
                              {analyticsIds.aps.failures.length > 0 ? (
                                <ResponsiveContainer width="100%" height="100%">
                                  <BarChart
                                    data={analyticsIds.aps.failures}
                                    margin={{
                                      top: 10,
                                      right: 30,
                                      left: -25,
            ...
            >
              <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
                {loading ? (
                  ...
                  <div className="py-20 text-center text-muted-foreground italic border border-dashed rounded-xl">
                    Nenhum relatório manual encontrado.
                  </div>
                ) : (
                  <Accordion
                    type="single"
                          ...
                          <AccordionTrigger className="hover:no-underline py-4">
                            <div className="flex items-center justify-between w-full pr-4">
                              <div className="flex items-center gap-4">
                                ...
                                >
                                  {(Math.round(
                                    (report.online_after_wake / report.total) *
                                      100,
                                  ) || 0) === 100 ? (
                                ...
                                <div className="rounded-md border border-destructive/20 bg-destructive/5 p-4">
                                  ...
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    {report.failures.map((fail, idx) => (
                                      <div
                                        key={idx}
                                        className="text-xs p-2 bg-background border rounded flex justify-between items-center shadow-sm"
                                      >
                                        <span className="font-semibold truncate max-w-[150px]">
                                          {fail.name}
                                        </span>
                                        <span className="font-mono text-[10px] opacity-60 ml-2 bg-muted px-1.5 py-0.5 rounded">
                                          {fail.ip}
                                        </span>
                                      </div>
                                    ))}
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="text-[10px] text-muted-foreground">
                                    Automático ({report.online_after_wake}/
                                    {report.total})
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="pb-4 pt-2">
                              {report.failures.length > 0 ? (
                                <div className="text-xs text-orange-600 bg-orange-50 p-3 rounded-lg border border-orange-100 italic leading-relaxed shadow-inner">
                                  <span className="font-bold not-italic block mb-1 uppercase text-[9px]">
