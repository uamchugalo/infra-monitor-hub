    ...
    <button
      ...
      className={cn(
        ...
        isEnabled
          ...
          : "bg-zinc-50 border-zinc-200 opacity-70 grayscale-[0.3]",
    ...
    >
      ...
      <div className="space-y-0.5">
        ...
        <div className="flex items-center gap-2">
          ...
          {pc.switchPort && (
            <span
              className="text-[9px] font-mono text-primary bg-primary/5 px-1 rounded flex items-center gap-0.5"
              title="Switch Port"
            >
              P:{pc.switchPort}
            </span>
