    ...
    <div className="h-full flex flex-col bg-card animate-fade-in border-l border-border w-[360px]">
      <div className="flex items-center justify-between p-4 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-foreground">Editar {type}</h2>
        ...
        <div className="p-4 space-y-5">
          ...
          >
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] text-muted-foreground">
                {enabled
                  ? "Dispositivo será pingado regularmente."
                  : "Dispositivo ignorado nas verificações."}
              </p>
            </div>
          ...
          <div className="p-4 bg-muted/50 rounded-lg border border-border">
            ...
            <p className="text-[10px] text-muted-foreground mt-2">
              {enabled
                ? "O status é verificado automaticamente a cada 3 minutos."
                : "O monitoramento para este dispositivo está pausado."}
            </p>
          </div>
                ...
                {history.length === 0 ? (
                  ...
                  <div className="divide-y divide-border">
                    {history.map((h: any) => (
                      <div
                        key={h.id}
                        className="p-2.5 hover:bg-muted/50 transition-colors flex items-start gap-3"
                      >
                        <div
                          className={cn(
      ...
      <div className="p-4 border-t border-border space-y-2">
        ...
        >
          <Activity
            className={cn("w-4 h-4 mr-2", isPinging && "animate-spin")}
          />
